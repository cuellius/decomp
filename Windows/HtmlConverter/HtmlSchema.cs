...
namespace Decomp.Windows.HtmlConverter
{
	internal class HtmlSchema
	{
		...
		{
		    return _htmlCharacterEntities.Contains(entityName);
		}

		internal static char EntityCharacterValue(string entityName)
		{
		    return _htmlCharacterEntities.Contains(entityName) ? (char)_htmlCharacterEntities[entityName] : (char)0;
		}

		private static void InitializeInlineElements()
		{
		    _htmlInlineElements = new ArrayList { "a", "abbr", "acronym", "address", "b",
                "bdo", "big", "button", "code", "del", "dfn", "em", "font", "i", "ins",
                "kbd", "label", "legend", "q", "s", "samp", "small", "span", "strike",
                "strong", "sub", "sup", "u", "var" };
		}

		private static void InitializeBlockElements()
		{
		    _htmlBlockElements = new ArrayList { "blockquote", "body", "caption", "center",
		        "cite", "dd", "dir", "div", "dl", "dt", "form", "h1", "h2", "h3", "h4", "h5",
		        "h6", "html", "li", "menu", "ol", "p", "pre", "table", "tbody", "td", "textarea",
		...
		{
		    _htmlEmptyElements = new ArrayList { "area", "base", "basefont", "br", "col", "frame", "hr", "img", "input", "isindex", "link", "meta", "param" };
		}

		private static void InitializeOtherOpenableElements()
		{
		    _htmlOtherOpenableElements = new ArrayList { "applet", "base", "basefont", "colgroup",
                "fieldset", "frameset", "head", "iframe", "map", "noframes", "noscript", "object",
                "optgroup", "option", "script", "select", "style", "title" };
		}

		private static void InitializeElementsClosingOnParentElementEnd()
		{
		    _htmlElementsClosingOnParentElementEnd = new ArrayList { "body", "colgroup", "dd", "dt", "head", "html", "li", "p", "tbody", "td", "tfoot", "thead", "th", "tr" };
		}
		...
		private static void InitializeElementsClosingOnNewElementStart()
		{
		    ...
		    _htmlElementsClosingDt = new ArrayList {"dd", "dt"}; 
